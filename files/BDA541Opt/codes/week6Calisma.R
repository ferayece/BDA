...
#w/out uncertainty: 
conc <- 40000
ipo <- mcstoc(rempiricalD, values=c(10,11,12,13,14,15), prob=c(0.1,0.2,0.3,0.2,0.1,0.1))
#print(ipo)
stock_price <-mcstoc(log,1.5,0.5)
expo <- conc*iop*stock_price
print(expo)
serving <- mcstoc(rgamma,shape=3.93,rate=0.0806)
  ...
  #NPV(cf0=0,cf=3200,times = 5,i=0.1,plot=FALSE)
